...
- [x] **Phase 1: Foundation** - Add line tracking and convention detection; establish the pipeline for new PatternInfo fields (completed 2026-03-09)
...
Plans:
- [x] 02-W0-PLAN.md — Test scaffold: 3 failing test files (usageExamples, dependencies, integration)
- [ ] 02-01-PLAN.md — Usage examples: extractExamples() + buildUsageExamplesSection() + wire into pipeline
- [ ] 02-02-PLAN.md — Dependency roles: upgrade extractDependencies() return type + buildMarkdown() dep block
...
Plans:
- [x] 03-W0-PLAN.md — Test scaffold: RED stubs for detectAntipatterns (ENRICH-04) and ## Don't Do section (OUTPUT-03)
- [ ] 03-01-PLAN.md — Antipattern detection: detectAntipatterns() with 4 rules + named export in patternDetector.js
- [ ] 03-02-PLAN.md — MD output: buildDontDoSection() + wire into detectFolderPattern() + buildMarkdown()
